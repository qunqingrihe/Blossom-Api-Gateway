...
public class DisruptorNettyCoreProcessor implements NettyProcessor{
    /**线程前缀*/
    private static final String THREAD_NAME_PREFIX="GATEWAY-CORE";
     ...
     */
    @Override
    public void process(HttpRequestWrapper wrapper){this.parallelQueueHandler.add(wrapper);}
    /**
